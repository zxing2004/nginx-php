...
# 源码包URL，可根据具体互联网链接环境修改合适的mirror
...
ENV NGINX_URL="https://nginx.org/download/nginx-$NGINX_VERSION.tar.gz" NGINX_ASC="https://nginx.org/download/nginx-$NGINX_VERSION.tar.gz.asc"
...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
	...
	&& curl -fSL ${NGINX_ASC} -o nginx.tar.gz.asc \
...
RUN chmod +x /usr/local/bin/docker-php-ext-* /usr/local/bin/nginx-php-startup && \
...
# 这里可以添加自定义配置文件或者安装php扩展，扩展安装方式和官方php镜像安装方式一样
COPY nginx/index.php /usr/share/nginx/html
